...
def route_Planner(current_query:str):
    if current_query=="CONVERSATIONAL":
        return generate_node
    elif current_query=="sql_lookup":
        return sql_lookup_node
    else :
        return retriever_node
graph.add_edge(START,"planner")
graph.add_conditional_edges("planner",route_Planner,{"CONVERSATIONAL": "generate", "sql_lookup": "sql_lookup", "retriever": "retriever"})
